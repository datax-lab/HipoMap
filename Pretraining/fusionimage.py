...
os.environ["CUDA_VISIBLE_DEVICES"] = "0,7,1"
...
from Models import inceptionv3_model,DoTNetmodel,Resnet_model
...
def generate_generator_multiple(generator, dir1, dir2):
    ...
    while True:
        ...
        yield [X2i[0], X2i[1]]  # Yield both images and their mutual label


traingenerator = generate_generator_multiple(generator=input_imgen,
                                             dir1=r"/home/skosaraju/CATNet2/CATNetExpirements/Train",
                                             dir2=r"/home/skosaraju/CATNet2/CATNetExpirements/Train5x",
                                             )
...
for lr in Lr:
    for beta1 in Beta_1:
        ...
        model.fit_generator(traingenerator,
                            steps_per_epoch=int(56037 /32),
                            epochs=epochs,

                            use_multiprocessing=False,
                            shuffle=False)

        model.save('RESNETn17.h5')
