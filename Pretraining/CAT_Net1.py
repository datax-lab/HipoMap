...
for lr in Lr:
    for beta1 in Beta_1:
        ...
        model = CATNet2.bulid1(InputA)
        model1 = multi_gpu_model(model, gpus=4)
        #         model =  CATNet2()
        # print(model.summary())
        # model = CATNet2()
        model1.compile(optimizer=Adam1, loss='mean_squared_error', metrics=['accuracy'])
        ...
        epochs = 50
        model1.fit_generator(traingenerator,
        ...
        # model.save('densevg15.h5')
        model1.save('CATNetvg.h5')
